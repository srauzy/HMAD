...
<br> Automatic detection of eyebrows raising and frowning (`EBMAD` script), smiling activity on the 5 levels Smiling Intensity Scale (`SMAD` script) or eye blinks detection are proposed.   
